...
*/
    ...
    /**
     * Se hace metodo entrada de datos en el sistema
     * @throws java.io.IOException
     */
    /*public void entradaDatos() throws IOException{
        
        Scanner cant = new Scanner(System.in);//Lector para la entrada de la cantidad de vertices, ciudades
        Scanner opc = new Scanner(System.in);//Lector para la opcion
        
        //Ensayo entrada de datos
        Scanner origen = new Scanner(System.in);//Lector para la opcion
        Scanner destino = new Scanner(System.in);//Lector para la opcion
        Scanner peso = new Scanner(System.in);//Lector para la opcion
         
        System.out.println("Añadir cantidad de ciudades:");//Ingreso cantidad vertices
        int cantidadCiudades = cant.nextInt();
        maxVertices = cantidadCiudades;
        //Crea un nuevo grafo de acuerdo a la cantidad dada
        Grafo nuevoGrafo = new Grafo(cantidadCiudades);        
        System.out.println("Añadir cantidad de caminos(Aristas):");//Ingreso cantidad Aristas
        int cantidadAristas = cant.nextInt();
        maxAristas = cantidadAristas;
        
        for(int i=0;i< cantidadCiudades;i++){//contador ciudad
            System.out.println("\nNombre del vertice ["+i+"]: ");
            String ciudad = nombreCiudad.nextLine();
            insertarVertice(i, ciudad);
        }System.out.println();//Fin for
        
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));//Entrada de datos: Origen Destino y Peso
        
        
        //Insertar Aristas
        
        System.out.println("\ningresar las aristas correspondientes a los vertices dados:\n"+
                "   NOTA: Escribir con numero y espacio -> 'ORIGEN' 'DESTINO' 'PESO'\n");
        
        for (int i = 0; i < cantidadAristas; i++) {
            System.out.println("\nDatos "+ i+" :");
            
            //Entrada de datos origen destino y peso
            
            //Forma 1 ingreso datos
            String datos [] =br.readLine().split(" ");
             insertar(Integer.parseInt(datos[0]), Integer.parseInt(datos[1]), Integer.parseInt(datos[2]));
            /*
            //Forma 2
            int orig = origen.nextInt();
            int det = destino.nextInt();
            int pes = peso.nextInt();
            insertar(orig, det, pes);
            */
        /*}
    ...
    *Menu principal
     * @throws java.io.IOException
   */
    /*public void MenuDelGrafo() throws IOException{
        System.out.println("\tMENU PRINCIPAL");
        System.out.println("\n1. Insertar datos.\n2.  Ejecutar algoritmos FloydWarshall y Dijkstra.\n3. Salir\nOpcion: ");
